...
export const Mappers = new Set([0,1,2,3,4,5,7,11,34,66]);

export function buildM(index, nes) {
    switch (index) {
        case 0: return new M0(nes);
        case 1: return new M1(nes);
        case 2: return new M2(nes);
        case 3: return new M3(nes);
        case 4: return new M4(nes);
        case 5: return new M5(nes);
        case 7: return new M7(nes);
        case 11: return new M11(nes);
        case 34: return new M34(nes);
        case 66: return new M66(nes);
        default: return null;
    }
}
...
class M1 extends M0{
    ...
    write = function(address, value) {
        ...
        if (address < 0x8000) {
            M0.prototype.write.apply(this, arguments);
            return;
        }
...
// Returns the register number from the address written to:
    ...
    toJSON = function() {
        var s = M0.prototype.toJSON.apply(this);
    ...
    fromJSON = function(s) {
        M0.prototype.fromJSON.apply(this, s);
